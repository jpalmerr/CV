...
[github.com/jpalmerr/pulseboard](https://github.com/jpalmerr/pulseboard)
...
- Three deployment options: CLI (YAML config), SDK (programmatic), Docker container
- Functional options pattern throughout for clean, composable API design
